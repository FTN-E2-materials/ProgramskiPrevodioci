...
{
       0,    57,    57,    65,    66,    71,    70,    87,    89,    98,
     101,   103,   107,   116,   118,   122,   123,   124,   125,   126,
     130,   134,   146,   147,   155,   156,   162,   163,   168,   171,
     177,   176,   194,   196,   206,   207,   211,   216,   215,   226,
     227,   231,   235,   240,   248,   256
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_READ", "_DATA", "_DO", "_FROM", "_COMMA", "_ID", "_INT_NUMBER",
  ...
  "read_statement", "$@3", "data_statements", "data_statement",
  "const_statements", "rel_exp", "return_statement", YY_NULLPTR
};
#endif
...
{
       4,     5,    25,     4,   -68,   -68,   -68,   -68,     8,    29,
      37,    20,   -68,    35,   -68,   -68,    47,    39,   -68,     2,
      36,    38,    33,    42,    40,   -68,   -68,   -68,   -68,   -68,
     -68,    50,   -68,   -68,   -68,    33,    43,   -68,   -68,    33,
     -17,   -68,   -68,   -68,   -68,    33,    23,    27,    -6,    41,
      45,    -3,   -68,    33,    51,     1,   -68,   -68,    33,    27,
      33,   -68,   -68,    54,   -68,    44,   -68,    44,    48,    24,
      34,   -68,   -68,   -68,    52,    27,   -68,    24,   -68,   -68
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,     0,     0,     0,    13,     9,    14,    15,    16,
      17,    34,    19,    18,    12,     0,    25,    28,    29,     0,
       0,    22,    24,    26,    37,     0,     0,     0,     0,     0,
       0,     0,    45,     0,     0,     0,    20,    35,     0,     0,
      32,    27,    23,     0,    21,    44,    36,    33,     0,     0,
       0,    39,    31,    42,    41,     0,    40,     0,    38,    43
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -68,   -68,   -68,    63,   -68,   -68,   -68,   -68,   -68,    46,
     -47,   -68,   -68,   -34,    14,   -67,   -68,   -68,   -68,   -68,
     -68,   -68,   -68,   -68,    -2,   -68,   -68,   -68
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      27,    28,    29,    40,    41,    42,    43,    50,    68,    30,
      31,    32,    54,    70,    71,    74,    49,    33
};
...
{
      57,    48,    73,    52,    53,    51,    21,     1,    22,    23,
      79,    55,    66,    61,    24,    53,    58,     5,    53,    25,
      26,    64,    53,     9,    65,     6,    67,    21,    78,    22,
      23,    21,    10,    22,    23,    24,    13,    37,    38,    24,
      25,    56,    69,    75,    25,    36,    37,    38,    39,    12,
      17,    20,    14,    35,    44,    47,    34,    59,   -30,    45,
      60,    63,    69,    77,    72,    53,     7,    62,    76,     0,
       0,    46
};

static const yytype_int8 yycheck[] =
{
      47,    35,    69,    20,    21,    39,     4,     3,     6,     7,
      77,    45,    59,    16,    12,    21,    22,    12,    21,    17,
      18,    20,    21,    15,    58,     0,    60,     4,    75,     6,
       7,     4,     3,     6,     7,    12,    16,    13,    14,    12,
      17,    18,     8,     9,    17,    12,    13,    14,    15,    12,
       3,    12,    17,    15,    12,     5,    20,    16,    15,    19,
      15,    10,     8,    11,    16,    21,     3,    53,    70,    -1,
      -1,    25
};
...
static const yytype_uint8 yystos[] =
{
      ...
      12,     4,     6,     7,    12,    17,    18,    34,    35,    36,
      43,    44,    45,    51,    20,    15,    12,    13,    14,    15,
      37,    38,    39,    40,    12,    19,    33,     5,    37,    50,
      41,    37,    20,    21,    46,    37,    18,    34,    22,    16,
      15,    16,    38,    10,    20,    37,    34,    37,    42,     8,
      47,    48,    16,    39,    49,     9,    48,    11,    34,    39
};
...
#line 216 "semantic.y" /* yacc.c:1646  */
	...
	idxPR=lookup_symbol((yyvsp[0].s), VAR|PAR);
	if(idxPR == NO_INDEX)
	  err("Promenljiva %s nije prethodno deklarisana ! [ERROR]",(yyvsp[0].s));
      }
...
#line 236 "semantic.y" /* yacc.c:1646  */
    {
	if(get_type(idxPR) != get_type((yyvsp[0].i)) )
