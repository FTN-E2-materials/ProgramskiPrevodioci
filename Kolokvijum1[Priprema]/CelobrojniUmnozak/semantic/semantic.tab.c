...
{
       0,    65,    65,    73,    74,    79,    78,    98,   100,   110,
     114,   116,   120,   124,   134,   146,   165,   164,   172,   178,
     188,   189,   193,   198,   209,   211,   215,   216,   217,   218,
     219,   220,   224,   228,   240,   241,   249,   250,   256,   261,
     262,   267,   270,   276,   275,   293,   295,   305,   306,   310,
     314,   322,   332
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_POSTINC", "_DO", "_WHILE", "_READ", "_DATA", "_FROM", "ONLY_IF",
  "$accept", "program", "function_list", "function", "$@1", "parameter",
  "body", "variable_list", "variable", "linking_vars", "do_while",
  "readFrom", "$@2", "nizIdeva", "data", "nizLiterala", "statement_list",
...
{
       7,    -4,    19,     7,   -62,   -62,   -62,   -62,    17,    18,
      33,    32,   -62,    37,   -62,   -62,    59,    61,   -62,    43,
       0,   -62,   -62,    62,    41,    38,    56,   -62,   -62,    30,
      64,   -62,   -62,   -62,   -62,   -62,   -62,    67,   -62,   -62,
      47,    25,   -62,   -62,    47,   -62,    23,   -62,   -62,   -62,
      47,    11,    52,   -62,   -16,    30,    48,    63,   -62,    65,
      -2,   -62,    47,    44,   -62,    66,    70,    55,   -62,    47,
      30,    47,   -62,   -62,   -62,    72,   -62,    58,    57,    68,
     -62,    68,    71,    69,    73,   -62,    58,    74,   -62,    58,
      58,    73,    30,    76,   -62,   -62,    75,   -62
};
...
{
       0,     0,     0,     2,     3,     5,     1,     4,     0,     7,
       0,     0,     8,     0,    10,     6,    24,     0,    11,     0,
       0,    13,    12,     0,     0,     0,     0,    24,     9,     0,
       0,    30,    31,    25,    26,    27,    28,    47,    29,    14,
       0,    37,    41,    42,     0,    52,     0,    34,    36,    39,
       0,     0,     0,    18,     0,     0,     0,     0,    38,     0,
       0,    51,     0,     0,    32,     0,     0,     0,    48,     0,
       0,    45,    40,    35,    33,     0,    19,     0,    16,    50,
      49,    46,     0,     0,    20,    22,     0,     0,    44,     0,
       0,    21,     0,     0,    23,    17,     0,    15
};
...
{
     -62,   -62,   -62,    78,   -62,   -62,   -62,   -62,   -62,   -62,
     -62,   -62,   -62,   -62,   -62,    -3,    77,   -29,   -62,   -62,
     -39,    26,   -61,   -62,   -62,   -62,   -62,   -62,   -62,   -62
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      31,    32,    87,    54,    78,    84,    20,    33,    34,    35,
      46,    47,    48,    49,    59,    82,    36,    37,    57,    38
};
...
{
      52,    56,    66,     5,    24,    60,    25,    26,    67,    72,
       1,    63,    27,    28,    62,    24,    85,    25,    26,     6,
      29,    10,    30,    27,    64,    85,    68,     9,    93,    94,
      79,    29,    81,    30,    24,   -43,    25,    26,    61,    62,
      12,    80,    27,    13,    58,    41,    42,    43,    44,    14,
      29,    40,    30,    45,    41,    42,    43,    44,    22,    74,
      62,    23,    17,    95,    62,    69,    42,    43,    21,    39,
      50,    53,    55,    65,    70,    71,    75,    76,    77,    83,
      86,     7,    88,    91,    62,     0,    89,    96,    73,     0,
      97,    90,     0,     0,    92,     0,     0,     0,     0,     0,
       0,     0,     0,     0,    51
};

static const yytype_int8 yycheck[] =
{
      29,    40,    18,     7,     4,    44,     6,     7,    24,    11,
       3,    50,    12,    13,    16,     4,    77,     6,     7,     0,
      20,     3,    22,    12,    13,    86,    55,    10,    89,    90,
      69,    20,    71,    22,     4,    10,     6,     7,    15,    16,
       7,    70,    12,    11,    19,     7,     8,     9,    10,    12,
      20,    10,    22,    15,     7,     8,     9,    10,    15,    15,
      16,    18,     3,    92,    16,    17,     8,     9,     7,     7,
      14,     7,     5,    21,    11,    10,    10,     7,    23,     7,
      23,     3,    11,    86,    16,    -1,    17,    11,    62,    -1,
      15,    18,    -1,    -1,    20,    -1,    -1,    -1,    -1,    -1,
      -1,    -1,    -1,    -1,    27
};
...
static const yytype_uint8 yystos[] =
{
       ...
       3,    31,     7,    11,    12,    32,    33,     3,    34,    35,
      42,     7,    15,    18,     4,     6,     7,    12,    13,    20,
      22,    36,    37,    43,    44,    45,    52,    53,    55,     7,
      10,     7,     8,     9,    10,    15,    46,    47,    48,    49,
      14,    42,    43,     7,    39,     5,    46,    54,    19,    50,
      46,    15,    16,    46,    13,    21,    18,    24,    43,    17,
      11,    10,    11,    47,    15,    10,     7,    23,    40,    46,
      43,    46,    51,     7,    41,    48,    23,    38,    11,    17,
      18,    41,    20,    48,    48,    43,    11,    15
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      33,    33,    34,    35,    35,    36,    38,    37,    39,    39,
      40,    40,    41,    41,    42,    42,    43,    43,    43,    43,
      43,    43,    44,    45,    46,    46,    47,    47,    47,    47,
      47,    48,    48,    50,    49,    51,    51,    52,    52,    53,
      54,    55,    55
};
...
#line 101 "semantic.y" /* yacc.c:1646  */
    {
        ...
        set_atr2(fun_idx, (yyvsp[-1].i));
		  if(get_type((yyvsp[-1].i)) == VOID) err("Parametri ne mogu biti tipa void!");
      }
...
#line 125 "semantic.y" /* yacc.c:1646  */
    {
        if(lookup_symbol((yyvsp[0].s), VAR|PAR) == -1)
           ...
           err("redefinition of '%s'", (yyvsp[0].s));
			...
			if(get_type((yyvsp[-1].i)) == VOID) err("Varijable ne mogu biti tipa void!");
      }
...
#line 147 "semantic.y" /* yacc.c:1646  */
    {
				int promjenljiva = lookup_symbol((yyvsp[-4].s), VAR|PAR);

				if(promjenljiva == -1)
					err("'%s' is undefined!", (yyvsp[-4].s));
				
				if(get_type(promjenljiva) != get_type((yyvsp[-2].i)))
...
#line 172 "semantic.y" /* yacc.c:1646  */
    {
					...
					if(idindex == -1) err("'%s' nije prethodno definisan!", (yyvsp[0].s));
					countIds++;
				}
...
#line 193 "semantic.y" /* yacc.c:1646  */
    {
							...
							if(get_type(idindex) != get_type((yyvsp[0].i))) err("Promjenljiva i literali nisu istog tipa!");
									countLiterals++;
						}
...
#line 257 "semantic.y" /* yacc.c:1646  */
    {
				...
				if((yyval.i) == -1) err("'%s' undeclared", (yyvsp[-1].s));
			}
...
#line 340 "semantic.y" /* yacc.c:1906  */
