...
{
       0,    52,    52,    60,    61,    66,    65,    82,    84,    93,
      96,    98,   102,   109,   118,   120,   124,   125,   126,   127,
     131,   136,   135,   158,   159,   167,   168,   174,   175,   180,
     183,   189,   188,   206,   208,   218,   219,   223,   227,   235
};
#endif
...
{
       4,     8,    17,     4,   -46,   -46,   -46,   -46,    10,    19,
      25,    29,   -46,    27,   -46,   -46,    -2,    34,    35,   -46,
      -1,    30,    31,    33,    28,    36,   -46,   -46,   -46,   -46,
     -46,   -46,    39,   -46,   -46,   -46,    28,    37,   -46,   -46,
      28,    -7,   -46,   -46,   -46,    28,    12,    22,    13,    38,
      41,    16,   -46,    28,    40,   -46,   -46,    28,    22,    28,
     -46,   -46,    43,    40,   -46,    40,    42,   -46,   -46
};
...
{
       0,     0,     0,     2,     3,     5,     1,     4,     0,     7,
       0,     0,     8,     0,    10,     6,    14,     0,     0,    11,
       0,     0,     0,     0,     0,     0,    14,     9,    15,    16,
      17,    18,    35,    19,    12,    13,     0,    26,    29,    30,
       0,     0,    23,    25,    27,     0,     0,     0,     0,     0,
       0,     0,    39,     0,    21,    20,    36,     0,     0,    33,
      28,    24,     0,    38,    37,    34,     0,    22,    32
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -46,   -46,   -46,    45,   -46,   -46,   -46,   -46,   -46,    26,
     -45,   -46,   -46,   -46,   -36,     1,   -46,   -46,   -46,   -46,
     -46,   -46,   -46,   -46
};
...
{
      -1,     2,     3,     4,     8,    11,    15,    16,    19,    20,
      28,    29,    30,    62,    41,    42,    43,    44,    50,    66,
      31,    32,    49,    33
};
...
{
      48,    17,    56,    23,    51,    24,    25,     1,    52,    54,
      53,    26,    27,    64,    18,     5,    23,     6,    24,    25,
       9,    63,    10,    65,    26,    55,    23,    60,    24,    25,
      53,    57,    12,    53,    26,    37,    38,    39,    40,    14,
      13,    21,    22,    36,    47,    34,    35,   -31,     7,    58,
      45,    59,    46,    68,    61,     0,     0,    53,    67
};

static const yytype_int8 yycheck[] =
{
      36,     3,    47,     4,    40,     6,     7,     3,    15,    45,
      17,    12,    13,    58,    16,     7,     4,     0,     6,     7,
      10,    57,     3,    59,    12,    13,     4,    11,     6,     7,
      17,    18,     7,    17,    12,     7,     8,     9,    10,    12,
      11,     7,     7,    10,     5,    15,    15,    10,     3,    11,
      14,    10,    26,    11,    53,    -1,    -1,    17,    15
};
...
static const yytype_uint8 yystos[] =
{
       ...
       3,    25,     7,    11,    12,    26,    27,     3,    16,    28,
      29,     7,     7,     4,     6,     7,    12,    13,    30,    31,
      32,    40,    41,    43,    15,    15,    10,     7,     8,     9,
      10,    34,    35,    36,    37,    14,    29,     5,    34,    42,
      38,    34,    15,    17,    34,    13,    30,    18,    11,    10,
      11,    35,    33,    34,    30,    34,    39,    15,    11
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 53 "semantic.y" /* yacc.c:1646  */
    {  
        if(lookup_symbol("main", FUN) == NO_INDEX)
          err("undefined reference to 'main'");
       }
#line 1286 "semantic.tab.c" /* yacc.c:1646  */
    break;
...
#line 1307 "semantic.tab.c" /* yacc.c:1646  */
    break;
...
#line 110 "semantic.y" /* yacc.c:1646  */
    {
        if(lookup_symbol((yyvsp[-1].s), VAR|PAR) == NO_INDEX)
           insert_symbol((yyvsp[-1].s), VAR, 10, ++var_num, NO_ATR);						//stavljam 10 kao type da bi znao da je promenljiva tipa AUTO
        else 
           err("redefinition of '%s'", (yyvsp[-1].s));
      }
...
#line 136 "semantic.y" /* yacc.c:1646  */
    {
				...
				printf("%d",lookup_symbol((yyvsp[-2].s), VAR|PAR));
				if(get_type(lookup_symbol((yyvsp[-2].s), VAR|PAR)) == 10)
					set_type(lookup_symbol((yyvsp[-2].s), VAR|PAR), get_type((yyvsp[0].i)) );
				else
...
#line 242 "semantic.y" /* yacc.c:1906  */
